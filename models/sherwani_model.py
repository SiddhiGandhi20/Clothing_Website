...
class SherwaniModel:
    def __init__(self, db):
        self.collection = db["sherwanis"]

    def create_item(self, name, price, image):
        """
        Create a new sherwanis item.
    ...
    def get_all_items(self):
        """
        Retrieve all sherwanis items.
        :return: List of sherwanis items or empty list on failure
        """
        try:
    ...
    def get_item_by_id(self, item_id):
        """
        Retrieve a sherwanis item by ID.
    ...
    def update_item(self, item_id, update_data):
        """
        Update an existing sherwanis item.
