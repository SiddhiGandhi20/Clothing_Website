...
class SherwaniDetailModel:
    ...
    def create_item(self, name, description, image, price, sherwani_id):
        """
        Create a new sherwani_details item.
        :param name: Name of the item
        :param description: Description of the item
        :param image: Filename of the image
        :param price: Price of the item
        :param sherwani_id: ID of the associated blazer set
    ...
    def get_all_items(self):
        """
        Retrieve all sherwani_details items.
        :return: List of sherwani_details items or empty list on failure
        """
        try:
            ...
            return [
                {
                    ...
                    "price": item["price"],
                    "sherwani_id": str(item["sherwani_id"]),
                }
                for item in items
            ]
        except PyMongoError as e:
    ...
    def get_item_by_id(self, item_id, base_url=None):
        """
        Retrieve a sherwani_details item by ID.
    ...
    def update_item(self, item_id, update_data):
        """
        Update an existing sherwani_details item.
    ...
    def delete_item(self, item_id):
        """
        Delete a sherwani_details item.
