...
class CoordSetDetailModel:
    ...
    def create_item(self, name, description, image, price, coordset_id):
        """
        Create a new coordset_details item.
        :param name: Name of the item
        :param description: Description of the item
        :param image: Filename of the image
        :param price: Price of the item
        :param coordset_id: ID of the associated blazer set
    ...
    def get_all_items(self):
        """
        Retrieve all coordset_details items.
        :return: List of coordset_details items or empty list on failure
        """
        try:
            ...
            return [
                {
                    ...
                    "price": item["price"],
                    "coordset_id": str(item["coordset_id"]),
                }
                for item in items
            ]
        except PyMongoError as e:
    ...
    def get_item_by_id(self, item_id, base_url=None):
        """
        Retrieve a coordset_details item by ID.
    ...
    def update_item(self, item_id, update_data):
        """
        Update an existing coordset_details item.
    ...
    def delete_item(self, item_id):
        """
        Delete a coordset_details item.
