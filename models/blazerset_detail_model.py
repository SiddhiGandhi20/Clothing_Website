...
class BlazersetDetailModel:
    ...
    def create_item(self, name, description, image, price, blazerset_id):
        """
        Create a new blazerset_details item.
        :param name: Name of the item
        :param description: Description of the item
        :param image: Filename of the image
        :param price: Price of the item
        :param blazerset_id: ID of the associated blazer set
    ...
    def get_all_items(self):
        """
        Retrieve all blazerset_details items.
        :return: List of blazerset_details items or empty list on failure
        """
        try:
            ...
            return [
                {
                    ...
                    "price": item["price"],
                    "blazerset_id": str(item["blazerset_id"]),
                }
                for item in items
            ]
        except PyMongoError as e:
    ...
    def get_item_by_id(self, item_id, base_url=None):
        """
        Retrieve a blazerset_details item by ID.
    ...
    def update_item(self, item_id, update_data):
        """
        Update an existing blazerset_details item.
    ...
    def delete_item(self, item_id):
        """
        Delete a blazerset_details item.
