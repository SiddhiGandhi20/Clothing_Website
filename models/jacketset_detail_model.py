...
class JacketSetDetailModel:
    ...
    def create_item(self, name, description, image, price, jacketset_id):
        """
        Create a new jacketset_details item.
        :param name: Name of the item
        :param description: Description of the item
        :param image: Filename of the image
        :param price: Price of the item
        :param jacketset_id: ID of the associated blazer set
    ...
    def get_all_items(self):
        """
        Retrieve all jacketset_details items.
        :return: List of jacketset_details items or empty list on failure
        """
        try:
            ...
            return [
                {
                    ...
                    "price": item["price"],
                    "jacketset_id": str(item["jacketset_id"]),
                }
                for item in items
            ]
        except PyMongoError as e:
    ...
    def get_item_by_id(self, item_id, base_url=None):
        """
        Retrieve a jacketset_details item by ID.
    ...
    def update_item(self, item_id, update_data):
        """
        Update an existing jacketset_details item.
    ...
    def delete_item(self, item_id):
        """
        Delete a jacketset_details item.
