...
class JacketSetModel:
    ...
    def get_all_items(self):
        """
        Retrieve all jacket_sets items.
        :return: List of jacket_sets items or empty list on failure
        """
        try:
    ...
    def get_item_by_id(self, item_id):
        """
        Retrieve a jacket_sets item by ID.
    ...
    def update_item(self, item_id, update_data):
        """
        Update an existing jacket_sets item.
