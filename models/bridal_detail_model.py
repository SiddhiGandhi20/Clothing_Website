...
class BridalWearDetailModel:
    def __init__(self, db):
        self.collection = db["bridal_wear_details"]

    def create_item(self, name, description, image, price, bridal_wear_id):
        """
        Create a new bridal_wear_details item.
        :param name: Name of the item
        :param description: Description of the item
        :param image: Filename of the image
        :param price: Price of the item
        :param bridal_wear_id: ID of the associated blazer set
        ...
        try:
            item = {
                ...
                "image": image,
                "price": price,
                "bridal_wear_id": ObjectId(bridal_wear_id),
            }
    ...
    def get_all_items(self):
        """
        Retrieve all bridal_wear_details items.
        :return: List of bridal_wear_details items or empty list on failure
        """
        try:
            ...
            return [
                {
                    ...
                    "price": item["price"],
                    "bridal_wear_id": str(item["bridal_wear_id"]),
                }
                for item in items
            ]
        except PyMongoError as e:
    ...
    def get_item_by_id(self, item_id, base_url=None):
        """
        Retrieve a bridal_wear_details item by ID.
    ...
    def update_item(self, item_id, update_data):
        """
        Update an existing bridal_wear_details item.
    ...
    def delete_item(self, item_id):
        """
        Delete a bridal_wear_details item.
